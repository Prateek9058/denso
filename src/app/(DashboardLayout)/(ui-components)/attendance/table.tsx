...
const Table: React.FC<TableProps> = ({
  ...
  const getFormattedData = (data: any[]) => {
    return data?.map((item, index) => ({
      ...
      status: getStatusInfo(item?.status ? "Present" : "Absent", index),
      checkIn: item?.checkIn ? moment(item?.checkIn).format("lll") : "N/A",
      checkOut: item?.checkOut ? moment(item?.checkOut).format("lll") : "N/A",
      Action: [
