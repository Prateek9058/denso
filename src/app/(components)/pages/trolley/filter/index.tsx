          ...
          <TabPanel value={activeStep} index={0}>
            <Grid container rowGap={2}>
              ...
              <Grid container columnGap={2}>
                ...
                <Button
                  variant={
                    selectedDept === "notAssigned" ? "contained" : "outlined"
                  }
                  onClick={() => handleSelectionChangeDept("notAssigned")}
                >
                  Not Assigned
                </Button>
              </Grid>
          ...
          <TabPanel value={activeStep} index={1}>
            <Grid container rowGap={2}>
              ...
              <Grid container columnGap={2}>
                ...
                <Button
                  variant={
                    selectedMen === "notAssigned" ? "contained" : "outlined"
                  }
                  onClick={() => handleSelectionChangeMen("notAssigned")}
                >
                  Not Assigned
                </Button>
              </Grid>
